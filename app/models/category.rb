class Category < ApplicationRecord
  ...
  has_attached_file :avatar1, :styles => { :medium => "700x700>", :thumb => "100x100#" }, 
  :default_url => "/images/"
  ...
  has_attached_file :avatar2, :styles => { :medium => "700x700>", :thumb => "100x100#" }, 
  :default_url => "/images/"
  ...
  has_attached_file :avatar3, :styles => { :medium => "700x700>", :thumb => "100x100#" }, 
  :default_url => "/images/"
